<template>
  ...
  <p>
    ...
    Hierbei kann es sich z.B. um Daten
  ...
  <p>
    ...
    Die personenbezogenen Daten, die auf dieser
  ...
  <p>
    ...
    und im Interesse einer sicheren, schnellen und effizienten Bereitstellung unseres
  ...
  <p>
    ...
    wie dies zur Erfüllung seiner Leistungspflichten
  ...
  <p>
    ...
    unserer Websitebesucher nur nach unseren Weisungen und unter Einhaltung
  ...
  <p>
    ...
    zur Datenverarbeitung widerrufen, werden Ihre Daten gelöscht, sofern wir keine anderen rechtlich
  ...
  <p>
    ...
    oder in Erfüllung eines Vertrags automatisiert
  ...
  <p>
    ...
    dürfen diese Daten – von ihrer Speicherung abgesehen –
  ...
  <p>
    ...
    Endgerät keinen Schaden an. Sie werden entweder vorübergehend für
    die Dauer einer Sitzung (Session-Cookies) oder dauerhaft (permanente Cookies)
  ...
  <p>
    ...
    da bestimmte Websitefunktionen ohne diese nicht funktionieren würden
  ...
  <p>
    ...
    (funktionale Cookies, z.B. für die Warenkorbfunktion)
    ...
    sofern keine andere Rechtsgrundlage angegeben wird.
    ...
    auf Grundlage dieser Einwilligung (Art. 6 Abs. 1
  ...
  <p>
    ...
    die Annahme von Cookies für bestimmte Fälle oder generell ausschließen sowie das automatische
  ...
  <p>
    ...
    in so genannten Server-Log-Dateien, die Ihr Browser
  ...
  <p>
    ...
    an der technisch fehlerfreien Darstellung und der Optimierung seiner Website – hierzu müssen
  ...
  <p>
    ...
    Matomo verwendet Technologien, die die seitenübergreifende Wiedererkennung
    des Nutzers zur Analyse des Nutzerverhaltens ermöglichen (z.B. Cookies oder
    Device-Fingerprinting). Die durch Matomo erfassten Informationen über die Benutzung
    dieser Website werden auf unserem Server gespeichert.
  ...
  <p>
    ...
    Hierdurch können wir u. a. herausfinden, wann welche Seitenaufrufe getätigt wurden und
    aus welcher Region sie kommen. Außerdem erfassen wir verschiedene Logdateien
    (z.B. IP-Adresse, Referrer, verwendete Browser und Betriebssysteme)
    und können messen, ob unsere Websitebesucher bestimmte Aktionen durchführen (z.B.
    Klicks, Käufe u. Ä.).
  </p>
  <p>
    Die Nutzung dieses Analyse-Tools erfolgt auf Grundlage von Art. 6 Abs. 1 lit.fDSGVO.
    Der Websitebetreiber hat ein berechtigtes Interesse an der anonymisierten Analyse
  ...
  <p>
    ...
    Hierbei wird Ihre IP-Adresse vor der Analyse gekürzt,
    sodass Sie Ihnen nicht mehr eindeutig zuordenbar ist.
  </p>
  <h4>Hosting</h4>
